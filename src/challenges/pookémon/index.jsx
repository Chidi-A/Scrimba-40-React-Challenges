...
export default function ChallengePokémon() {
  ...
  function updatePosition() {
    ...
    const operation =
      direction === 'right' || direction === 'down' ? addition : subtraction;
    ...
    if (direction === 'right' || direction === 'left') {
      ...
      limitToCheck =
        direction === 'right' ? boundaries.xAxis.max : boundaries.xAxis.min;
    } else {
      positionToUpdate = 'yPosition';
      limitToCheck =
        direction === 'down' ? boundaries.yAxis.max : boundaries.yAxis.min;
    }
      ...
      >
        <div className="console-container">
          <img
            ...
            src="./PookachuBackgroundImage.png"
          />
          <Controls />
          <GameScreen
