...
export default function SolicitationMessage() {
  ...
  return (
    <p>
      ...
      newsletter! I swear I will never spam you with clickbaity attempts to
      upsell you! No, really, I won't — I promise! Oh, also, if you want to
      learn the <span>one secret trick</span> that the creators of React don't
