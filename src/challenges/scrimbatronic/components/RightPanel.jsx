...
export default function RightPanel(props) {
  ...
  const [changeAllNotesPlayback, setChangeAllNotesPlayback] =
    ...
    <div className="right-panel-container">
      <div className="playback-container">
        <div className="icon-container">
          <img className="fast-icon" src="rabbit.png" />
        </div>
        <button
        ...
        <div className="icon-container">
          <img className="slow-icon" src="turtle.png" />
        </div>
      </div>
      ...
      <div className="volume-container">
        <div className="icon-container">
          <img className="volume-high-icon" src="volume-high-icon.svg" />
        </div>
        ...
        <div className="icon-container">
          <img className="volume-low-icon" src="volume-low-icon.svg" />
        </div>
      </div>
    </div>
  );
