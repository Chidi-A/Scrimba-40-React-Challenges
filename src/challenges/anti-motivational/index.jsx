...
export default function App() {
  ...
  function getRandomItem(targetObject) {
    ...
    const randomIndex = Math.floor(Math.random() * length); // eslint-disable-line react-hooks/purity
...
*/
  ...
  return (
    <div className="anti-motivational">
      <div className="wrapper" style={currentData.image.wrapperStyles}>
        ...
        >
          <p
            ...
            style={{
              ...smallestFontSize,
              color: currentData.image.containerStyles.color,
            }}
          >
