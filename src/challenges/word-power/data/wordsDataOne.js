export default [
  {
    ...
    definition: [
      ...
      'Rude, disrespectful, impudent, or arrogant behavior.',
    ],
    icon: '💪',
    category: 'power word',
    ...
    etymology:
      'Middle English audacite, from Medieval Latin audācitāt-, audācitās, from Latin audāc-, audāx, meaning daring, bold, etc.',
  },
  {
    word: 'liminal',
    pronunciation: 'li - muh - nuhl',
    definition: [
      'Located at or on both sides of a boundary or threshold.',
      'Relating to an initial or intermediate stage of a process, period, or state.',
    ],
    icon: '🤓',
    category: 'technical',
    ...
    example:
      '"Having recently turned 18 years old, Tim was in that strange liminal space between adolescence and adulthood."',
    synonyms: [
      'interstitial',
      'intermediate',
      'unsettled',
  ...
  },
  {
    ...
    definition: [
      'Soil or debris produced by the weathering and disintegration of rock in the same place as its origin (rather than carried there by wind or water).',
    ],
    icon: '🥼',
    category: 'scientific',
    ...
    partOfSpeech: 'noun',
    example:
      '"Many precious minerals could be found in the eluvium of the region, so the mining company concentrated its operations there."',
    synonyms: ['eluvial deposits'],
    antonyms: ['alluvium', 'colluvium', ''],
    etymology:
      'Latin: eluere, meaning to to wash out, and alluere, meaning to wash against.',
  },
  {
    word: 'crepuscular',
    ...
    partOfSpeech: 'adjective',
    example:
      '"In the faint, crepuscular light that filled the sky in the minutes after sunset, the distant mountains looked like faint silhouettes rising up from the horizon."',
  ...
  },
  {
    ...
    definition: [
      'To walk around a place, especially if you are doing it for pleasure and in a leisurely manner.',
    ],
    icon: '🎩',
    ...
    partOfSpeech: 'verb',
    example:
      '"The police officer asked me what I was doing there, and I told him I was just perambulating around. The next thing I knew, I woke up in a jail cell."',
    synonyms: [
      'walk',
      'stroll',
      'amble',
    ...
    etymology:
      'Latin: from the verb perambulare —  per (‘all over’) + ambulare (‘to walk’)',
  },
  {
    word: 'loquacious',
    ...
    partOfSpeech: 'adjective',
    example:
      '"My nephew is a loquacious little kid. He talked my ear off the entire car ride to the store."',
    synonyms: [
      'talkative',
      'voluble',
      'verbose',
  ...
  },
  {
    ...
    definition: [
      'To foreshadow or indicate something vaguely.',
      'To report or represent something in outline.',
      'To overshadow or obscure something.',
    ],
    icon: '🤵🏻‍♂️',
    ...
    partOfSpeech: 'verb',
    example:
      '"In his latest essay, the philosopher adumbrated a new theory of knowledge, but he will need to do more work in the future to fill in all of the details."',
    synonyms: [
      'foreshadow',
      'portend',
      'indicate',
    ...
    etymology:
      "Latin: from adumbrāre, meaning to shade, outline, or represent something by means of light and shade.'",
  },
];
