...
export default function App() {
  ...
  function handleClick(event) {
    ...
    setPassedEmojis((prev) => [
      ...prev,
      ...currentEmojis.filter((emoji) => emoji !== clickedEmoji),
    ]);
...
*/
  ...
  function getRandomEmojis() {
    ...
    return new Array(3).fill('').map((item) => chooseRandomEmoji()); // eslint-disable-line no-unused-vars
  }
  ...
  return (
    <div className="emoji-personality-test">
