...
export default function Stock(props) {
  const { stockName, logo, currentPrice, prevClosingPrice } = props.stock;
  /* Challenge
...
*/
  ...
  const colorClass = currentPrice > prevClosingPrice ? 'green' : 'red';

  const arrow = currentPrice > prevClosingPrice ? '⬆' : '⬇';
