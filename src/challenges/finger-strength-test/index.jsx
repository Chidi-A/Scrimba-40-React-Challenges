...
export default function ChallengeFingerStrengthTest() {
  ...
  /* Challenge
	...
	This virtual amusement park game is broken because a horrible hacker deleted two of its states and four of its event handlers. 
    Your task is to fix it by doing the following: 
	
		1. If the user's cursor goes inside the "Hold Down" button and they press down their 
		   mouse button, the two missing states should have their values change accordingly. If these state changes happen, 
           then the existing code in the useEffect of the try block below should make the timer and thermometer start to go up.
		...
		3. All of these things should be accomplished simply via changes in the missing state 
		   values, which are triggered by the missing event handlers. 
           You SHOULD NOT delete, add, or modify any code beside these missing states and event handlers. 
           The try block and the useEffect below will work perfectly fine as they are already written if you do this correctly. 
...
*/
  ...
  try {
    ...
    console.log(
      'HAHA, your app has been hacked! I deleted two of your states and four of your event handlers! Try to see if you can catch them 😜',
    );
  }

  /*------Add the event handlers below!----------------------------*/
  return (
    <div className="finger-strength-test">
      <div className="wrapper">
        ...
        <button
          ...
          onMouseLeave={() => setCursorInButton(false)}
