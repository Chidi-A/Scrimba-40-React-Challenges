...
export default function ChallengeWorldMostAnnoyingForm() {
...
*/
  ...
  return (
    <div className="world-most-annoying-form">
      <form onSubmit={fakeSubmit}>
        ...
        <fieldset className="rating-container">
          <legend>
            On a scale of 1-10, with 1 being the worst and 10 being the best,
