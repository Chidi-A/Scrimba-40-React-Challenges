export default {
  availableItems: [
    {
      fakeQuote:
        'If you redefine success as failure, you will always be able to succeed.',
    ...
    {
      fakeQuote:
        "The smaller your dreams are, the smaller your disappointment will be when they don't come true.",
      fakeSource: 'Florence Nightingale',
      quoteFontSize: { fontSize: '30px' },
    },
    {
      fakeQuote:
        'The lower you set your goals, the less likely you will be to fall short of them.',
      fakeSource: 'Plato',
      quoteFontSize: { fontSize: '30px' },
    },
    {
    ...
    {
      fakeQuote:
        "You will never see your empire crumble if you don't have an empire in the first place.",
    ...
    {
      fakeQuote:
        "You cannot be knocked down if you're already flat on your face.",
      fakeSource: 'Arthur Schopenhauer',
      quoteFontSize: { fontSize: '37px' },
    },
    {
      fakeQuote:
        'If you lower your standards far enough, you will always exceed your expectations.',
      fakeSource: 'Simone de Beauvoir',
      quoteFontSize: { fontSize: '37px' },
    },
    {
      fakeQuote:
        'Your words will never be misunderstood if they never leave your head.',
      fakeSource: 'Emily Dickinson',
      quoteFontSize: { fontSize: '37px' },
    },
    {
      fakeQuote:
        "Even if you're not succeeding, you're still succeeding at not succeeding, so it's alright.",
    ...
    {
      fakeQuote:
        'The secret to always knowing where your life is going is to get it stuck in an infinite loop.',
      fakeSource: 'Alan Turing',
      quoteFontSize: { fontSize: '30px' },
    },
    {
      fakeQuote:
        'The shortest path between point A and point B is to put the two points on top of each other.',
      fakeSource: 'Isaac Newton',
      quoteFontSize: { fontSize: '30px' },
    },
    {
      fakeQuote:
        'Your enemies cannot defeat you by exploiting your weaknesses if you defeat yourself by exploiting them first.',
      fakeSource: 'Sun Tzu',
      quoteFontSize: { fontSize: '30px' },
    },
    {
    ...
    {
      fakeQuote:
        "The world is a stage — and if you don't have an audience, your performance will never be booed.",
      fakeSource: 'William Shakespeare',
      quoteFontSize: { fontSize: '30px' },
    },
    {
      fakeQuote:
        "You don't have to worry about finishing the things you never start.",
    ...
    {
      fakeQuote:
        'If you only dream about what you already have, your dreams will always come true.',
