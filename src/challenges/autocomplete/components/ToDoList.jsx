...
export default function ToDoList() {
  ...
  const [autoCompleteRequested, setAutoCompleteRequested] =
    React.useState(false);
  const [isNewItemInputFocused, setIsNewItemInputFocused] =
    React.useState(false);
    ...
    <div>
      <div className="to-do-list-container">
        ...
        <label className="new-item-label">
          <img
            src="/add-item.svg"
            className={`add-item-icon ${isNewItemInputFocused && 'faded'}`}
          />
          <input
            ...
            onFocus={() => setIsNewItemInputFocused(true)}
            onBlur={() => setIsNewItemInputFocused(false)}
            value={newItemInput}
          />
        </label>
      </div>
