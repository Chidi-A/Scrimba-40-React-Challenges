  ...
  function handlePixelEnter(id) {
    ...
    setPixels((prevPixels) =>
      prevPixels.map(
        (pixel) =>
          pixel.id === id
            ? { ...pixel, filled: wantsToDraw } // update only filled
            : pixel, // everything else preserved
      ),
    );
  }
      ...
      >
        ...
        >
          ...
          <div className="button-container">
            ...
            <button onClick={togglePencil}>
              {wantsToDraw ? 'Erase' : 'Draw'}
            </button>
          </div>
        </div>
      </div>
